...
const DozenBet = ({ chooseBet, imageChip, outSideBet, statusRandom }) => {
    return (
        <div className="grid grid-cols-3 mt-1 gap-1">
            <button style={{ outline: '0', cursor: 'url(' + ImageChipCursor + '), pointer' }} disabled={outSideBet.DOZEN1st === false || statusRandom === true ? true : false}
            ...
            <button style={{ outline: '0', cursor: 'url(' + ImageChipCursor + '), pointer' }} disabled={outSideBet.DOZEN2nd === false || statusRandom === true ? true : false}
            ...
            <button style={{ outline: '0', cursor: 'url(' + ImageChipCursor + '), pointer' }} disabled={outSideBet.DOZEN3rd === false || statusRandom === true ? true : false}
